...
.field public static final EMPTY_PASSWORD:[C
...
.method public static createSSLContext(Ljava/lang/String;Ljava/security/KeyStore;Ljava/lang/String;Ljava/security/KeyStore;Ljava/security/SecureRandom;Lorg/apache/http/conn/ssl/TrustStrategy;)Ljavax/net/ssl/SSLContext;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/NoSuchAlgorithmException;,
...
.method public static createSystemSSLContext()Ljavax/net/ssl/SSLContext;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/apache/http/conn/ssl/SSLInitializationException;
...
.method public static createSystemSSLContext(Ljava/lang/String;Ljava/security/SecureRandom;)Ljavax/net/ssl/SSLContext;
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    :cond_5
    sget-object v3, Lorg/apache/http/conn/ssl/SSLSocketFactory;->EMPTY_PASSWORD:[C
    ...
    :cond_e
    sget-object v5, Lorg/apache/http/conn/ssl/SSLSocketFactory;->EMPTY_PASSWORD:[C
...
.method public connectSocket(Ljava/net/Socket;Ljava/lang/String;ILjava/net/InetAddress;ILorg/apache/http/params/HttpParams;)Ljava/net/Socket;
    ...
    invoke-direct {v0, v1, p5, p3}, Lorg/apache/http/conn/HttpInetSocketAddress;-><init>(Lorg/apache/http/HttpHost;Ljava/net/InetAddress;I)V

    .line 28
    invoke-virtual {p0, p1, v0, p4, p6}, Lorg/apache/http/conn/ssl/SSLSocketFactory;->connectSocket(Ljava/net/Socket;Ljava/net/InetSocketAddress;Ljava/net/InetSocketAddress;Lorg/apache/http/params/HttpParams;)Ljava/net/Socket;
...
.method public connectSocket(Ljava/net/Socket;Ljava/net/InetSocketAddress;Ljava/net/InetSocketAddress;Lorg/apache/http/params/HttpParams;)Ljava/net/Socket;
    ...
    .line 8
    instance-of p3, p2, Lorg/apache/http/conn/HttpInetSocketAddress;
    ...
    check-cast p3, Lorg/apache/http/conn/HttpInetSocketAddress;

    invoke-virtual {p3}, Lorg/apache/http/conn/HttpInetSocketAddress;->getHttpHost()Lorg/apache/http/HttpHost;
